...
public class ArvoreArtefatoValor {
    ...
    private No<Artefato> inserirBRec(No<Artefato> raiz, Artefato artefato) {
        if (raiz == null) {
            ...
            if (raiz.getObjeto().getValorHistorico() > artefato.getValorHistorico()) {
    ...
    private void preorderRec(No<Artefato> raiz) {
        if (raiz != null) {
            System.out.print(raiz.getObjeto().getNome() +": "+ raiz.getObjeto().getValorHistorico() + " |");
    ...
    private boolean buscarRec(No<Artefato> raiz, Artefato artefato) {
        if (raiz == null) {
            ...
            if (artefato.getValorHistorico() == raiz.getObjeto().getValorHistorico()) {
                return true;
            } else if (raiz.getObjeto().getValorHistorico() < artefato.getValorHistorico()) {
